...
const main = async () => {
  ...
  // ============ MATIC/USDC ============
  {
    ...
    const uniswapV3PriceData = await UniswapV3.getPrice(
      poolContract('0xa374094527e1673a86de625aa59517c5de346d32', IUniswapV3PoolABI),
      18,
      6,
      3000
    );
    // https://info.quickswap.exchange/#/pair/0x6e7a5fafcec6bb1e78bae2a1f0b612012bf14827
    const quickSwapData = await UniswapV2.getPrice(
      poolContract('0x6e7a5fafcec6bb1e78bae2a1f0b612012bf14827', IUniswapV2PairABI),
      3000
    );
  ...
  // ============ USDC/USDT ============
  {
    ...
    const uniswapV3PriceData = await UniswapV3.getPrice(
      poolContract('0x3f5228d0e7d75467366be7de2c31d0d098ba2c23', IUniswapV3PoolABI),
      6,
      6,
      3000
    );
    ...
    const quickSwapData = await UniswapV2.getPrice(
      poolContract('0x2cf7252e74036d1da831d11089d326296e64a728', IUniswapV2PairABI),
      3000
    );
