...
export const IPolygonContractABI = [
  {
    inputs: [{ internalType: 'address', name: '_flashAddrProvider', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor'
  },
  {
    ...
    inputs: [
      {
        components: [
          {
            ...
            internalType: 'struct Arbitrage.SwapInfo',
            name: 'buy',
            type: 'tuple'
          },
          {
        ...
        internalType: 'struct Arbitrage.ArbitInfo',
        name: '_data',
        type: 'tuple'
      },
